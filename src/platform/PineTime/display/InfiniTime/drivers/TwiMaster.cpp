...
void TwiMaster::Read(uint8_t deviceAddress, uint8_t registerAddress,
...
void TwiMaster::Write(uint8_t deviceAddress, uint8_t registerAddress,
...
void TwiMaster::Read(uint8_t deviceAddress, uint8_t *buffer, size_t size,
                     bool stop) {
...
void TwiMaster::Write(uint8_t deviceAddress, const uint8_t *data, size_t size,
                      bool stop) {
  twiBaseAddress->ADDRESS = deviceAddress;
  twiBaseAddress->TASKS_RESUME = 0x1UL;
